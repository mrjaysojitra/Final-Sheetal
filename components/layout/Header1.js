            ...
            <header className={`main-header header-style-one ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
                <div className="main-box">
                    <div className="logo-box">
                        <div className="logo"><Link href="/"><Image src={LogoWhite} title='Shital' /></Link></div>
                    </div>
                    <div className="nav-outer">
                        ...
                        <div className="outer-box">
                            <Link href="tel:+919328090700" className="info-btn">
                                <i className="icon fa fa-phone" />
                                <small>Call Anytime</small><br /> +91 93280 90700
                            </Link>
                ...
                <div className="mobile-menu">
                    ...
                    <nav className="menu-box">
                        <div className="upper-box">
                            <div className="nav-logo"><Link href="/"><Image src={LogoDark} title='Shital' /></Link></div>
                        ...
                        <ul className="contact-list-one">
                            <li>
                                <div className="contact-info-box">
                                    ...
                                    <Link href="/tel:+919328090700">+91 93280 90700</Link>
                                </div>
                            </li>
                            <li>
                                <div className="contact-info-box">
                                    ...
                                    <Link href="/mailto:shitalacademyit@gmail.com">shitalacademyit@gmail.com</Link>
                                </div>
                            </li>
                            <li>
                                <div className="contact-info-box">
                                    ...
                                    <span className="title">Send Email</span>
                                    Mon - Sat 8:00 - 9:00, Sunday - CLOSED
                                </div>
                            </li>
                        </ul>
                        <ul className="social-links">
                            <li><Link href="https://twitter.com/ShitalAcademy"><i className="fab fa-twitter" /></Link></li>
                            <li><Link href="https://www.facebook.com/sheetal.bhavnagar"><i className="fab fa-facebook-f" /></Link></li>
                ...
                <div className={`sticky-header ${scroll ? "fixed-header animated slideInDown" : ""}`}>
                    <div className="auto-container">
                        <div className="inner-container">
                            <div className="logo">
                                <Link href="/" title><Image src={LogoWhite} title='Shital' /></Link>
                            </div>
                            <div className="nav-outer">
